...
const UserMenu = () => {
    ...
    return (
        <Tooltip
            className='border border-amber-500 bg-black bg-opacity-60'
            content={
                <div>
                    <h3 className='border-b border-amber-500 font-noto text-sm font-medium text-amber-500'>
                        {user?.displayName}
                    </h3>
                    <p className='text-xm text-center opacity-80'>
                        click for more info
                    </p>
                </div>
            }
        ...
        >
            <Menu>
                ...
                <MenuList className='border-amber-500 bg-black bg-opacity-80 text-white'>
                    <NavLink
                        to={'/profileDetails'}
                        className={({ isActive }) =>
                            isActive
                                ? 'flex items-center gap-2 rounded-md bg-gray-600 p-2 outline-none'
                                : 'flex items-center gap-2 rounded-md p-2 outline-none hover:bg-gray-600'
                        }
                    >
                        <svg
                            width='16'
                    ...
                    <NavLink
                        ...
                        className={({ isActive }) =>
                            isActive
                                ? 'mt-1 flex items-center gap-2 rounded-md bg-gray-600 p-2 outline-none'
                                : 'mt-1 flex items-center gap-2 rounded-md p-2 outline-none hover:bg-gray-600'
                        }
                    >
                        <svg
                            width='16'
                    ...
                    <button
                        ...
                        className='flex w-full items-center gap-2 rounded-md p-2 outline-none hover:bg-gray-600'
                    >
                        <svg
                            width='16'
                            height='14'
